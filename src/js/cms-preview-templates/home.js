...
export default class PostPreview extends React.Component {
  render() {
    ...
    return <div>
        <Jumbotron image={getAsset(entry.getIn(["data", "image"]))} title={entry.getIn(["data", "title"])} subtitle={entry.getIn(["data", "subtitle"])}/>
          ...
          <div className="ph3 mw7 center">
            ...
            <div className="flex-l mhn2-l">
              ...
              <div className="w-60-l ph2-l">
                <img src={getAsset(entry.getIn(["data", "testimonials", "image"]))} alt="" className="mb3"/>
              </div>
            </div>

            <div className="tc">
              <a href="{{.buttonLink}}" className="btn raise">Read testimonials</a>
            </div>
